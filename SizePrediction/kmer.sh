...
FastK -v -t4 -k21 -M16 -T4 /data01/mlandi/Inqaba/data/HiFi_filtered/filtered_cells_merged.fastq.gz -NStatKmer21
smudgeplot.py hetmers -L 12 -t 4 -o kmerpairs --verbose StatKmer21
python3.11 /usr/local/bin/smudgeplot.py all -o trialKmer21 kmerpairs.smu -ylim 100
